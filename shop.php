   ...
   <body>
      ...
      <section class="products">
         ...
         <div class="box-container">
            <?php  
               $select_products = mysqli_query($conn, "SELECT * FROM `products`") or die('query failed');    //Ανάκτηση όλων των εγγραφών από τον πίνακα products
               if(mysqli_num_rows($select_products) > 0){         //Αν ο πίνακας δεν είναι άδειος
